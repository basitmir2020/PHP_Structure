<?php
      ...
      // modulePath="Admin", defaultControllerName="Auth", defaultMethodName="index"
      // templateNamePrefix "__Admin__" was removed from constructor.
      $app = new \App\Core\CoreRouter("Admin", "Auth", "index"); // Use FQN, updated for new constructor
?>