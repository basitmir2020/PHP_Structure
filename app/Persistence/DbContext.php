...
class DbContext
{ // Renamed from dbContext to DbContext for PSR-1 compliance
    private $con = null;
    ...
    {
        $dsn = "mysql:host=" . \App\Config\Config::DB_HOST . ";dbname=" . \App\Config\Config::DB_NAME . ";charset=utf8mb4";
        $options = [
        ...
        try {
            return new PDO($dsn, \App\Config\Config::DB_USER, \App\Config\Config::DB_PASS, $options);
